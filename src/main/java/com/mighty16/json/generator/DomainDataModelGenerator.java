 ...
 */
public class DomainDataModelGenerator extends KotlinFileGenerator {

    private String fileName;

    public DomainDataModelGenerator(String fileName, LanguageResolver resolver, AnnotationGenerator annotations, FileSaver fileSaver) {
